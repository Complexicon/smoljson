-- script from https://github.com/tarruda/premake-export-compile-commands
-- with some pull requests patched in
...
local function execute()
  for wks in p.global.eachWorkspace() do
    ...
    for cfgKey,cmds in pairs(cfgCmds) do
      local outfile = string.format('clangd/%s/compile_commands.json', cfgKey)
